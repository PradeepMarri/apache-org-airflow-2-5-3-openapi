...
func Get_connectionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.ConnectionCollection
...
func CreateGet_connectionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_connections",
		mcp.WithDescription("List connections"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_connectionsHandler(cfg),
	}
}
