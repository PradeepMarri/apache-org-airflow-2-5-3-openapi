...
func Get_event_logsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/eventLogs%s", cfg.BaseURL, queryString)
		...
		var result models.EventLogCollection
...
func CreateGet_event_logsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_eventLogs",
		mcp.WithDescription("List log entries"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_event_logsHandler(cfg),
	}
}
