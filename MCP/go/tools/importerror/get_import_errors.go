...
func Get_import_errorsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/importErrors%s", cfg.BaseURL, queryString)
		...
		var result models.ImportErrorCollection
...
func CreateGet_import_errorsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_importErrors",
		mcp.WithDescription("List import errors"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_import_errorsHandler(cfg),
	}
}
