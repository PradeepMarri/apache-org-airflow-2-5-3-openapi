...
func Get_permissionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/permissions%s", cfg.BaseURL, queryString)
		...
		var result models.ActionCollection
...
func CreateGet_permissionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_permissions",
		mcp.WithDescription("List permissions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_permissionsHandler(cfg),
	}
}
