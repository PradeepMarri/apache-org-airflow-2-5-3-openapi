...
func Get_pluginsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.PluginCollection
...
func CreateGet_pluginsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_plugins",
		mcp.WithDescription("Get a list of loaded plugins"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_pluginsHandler(cfg),
	}
}
