...
func Get_variablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.VariableCollection
...
func CreateGet_variablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_variables",
		mcp.WithDescription("List variables"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_variablesHandler(cfg),
	}
}
